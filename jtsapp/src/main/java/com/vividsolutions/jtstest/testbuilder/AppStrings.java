...
public class AppStrings {
  ...
  public static final String TEXT_ENTRY_TIP = "Enter WKT, WKB GeoJSON, or GML, or drag-n-drop a WKT, WKB, GeoJSON, GML or SHP file";
  public static final String WKT_PANEL_LOAD_GEOMETRY_TIP = "Load geometries";
  public static final String INSPECT_GEOMETRY_TIP = "Inspect Geometry";
